...
async function getStaticPaths() {
  ...
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://huyhung:hung2503@cluster0.moxmi.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
async function getStaticProps(context) {
  ...
  const selectedMeetup = await meetupsCollection.findOne({
    _id: Object(external_mongodb_["ObjectId"])(meetupId) //flitter _id,
